            ...
            <div className="grid grid-cols-1 items-start md:grid-cols-1 text-neutral-500">
              <p>
                ...
                <a
                  ...
                  href="https://twitter.com/sanchayjaveria"
                  title="Twitter"
                  target="_blank"
                ...
                <a
                  className="text-black duration-200 hover:no-underline underline after:content-['_↗']"
                  href="mailto:hello@sanchayjaveria.com"
                  title="Email"
                >
              ...
              <div className="md:col-span-2 w-full">
                <p className="dark:text-white text-black">
                  <a
                    title="LinkedIn"
                    className="text-black duration-200 hover:no-underline underline after:content-['_↗']"
                    href="https://www.linkedin.com/in/sanchay0/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    sanchay0
              ...
              <div className="md:col-span-2 w-full">
                <p className="dark:text-white text-black">
                  <a
                    title="Resume"
                    className="text-black duration-200 hover:no-underline underline after:content-['_↗']"
                    href="https://sanchay.s3.us-east-2.amazonaws.com/resume.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    sanchay_javeria
              ...
              <div className="md:col-span-2 w-full">
                <p className="dark:text-white text-black">
                  <a
                    title="Github"
                    className="text-black duration-200 hover:no-underline underline after:content-['_↗']"
                    href="https://www.github.com/sanchay0/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    sanchay0
