  ...
  return (
    <div className="mt-10">
      ...
      <ul>
        ...
        <li>
          <p className="mt-2">
            ...
            &quot;Our&quot; in this Agreement) refers to Sanchay&apos;s Blog.
          </p>
        </li>
        <li>
          <p className="mt-2">
        ...
        <li>
          <p className="mt-2">
            <span className="font-medium">Country</span> refers to: California,
            United States
          </p>
        </li>
        <li>
        ...
        <li>
          <p className="mt-2">
            ...
            Sanchay&apos;s Blog, accessible from{" "}
            <a
              href="https://www.sanchayjaveria.com/"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://www.sanchayjaveria.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          <p className="mt-2">
            <span className="font-medium">To contact You:</span> To contact You
