    ...
    <div data-custom-class="body">
          ...
          <strong>
            <span style={{ fontSize: 15 }}>
              <span data-custom-class="subtitle">
                Last updated <span className="question">November 07, 2024</span>
              </span>
            </span>
          </strong>
        </span>
        ...
        <span style={{ color: "rgb(127, 127, 127)" }}>
          <span style={{ fontSize: 15 }}>
            ...
            <span data-custom-class="body_text">
              ...
              and/or share (<span className="block-component" />"
              <strong>process</strong>"
              <span className="statement-end-if-in-editor" />) your personal
            ...
            <span style={{ fontSize: 15 }}>
              <span data-custom-class="body_text">
                ...
                <span style={{ color: "rgb(0, 58, 250)" }}>
                  <span className="question">
                    <a href="http://www.sanchayjaveria.com">
                      http://www.sanchayjaveria.com
                    </a>
                  </span>
                </span>
                <span style={{ fontSize: 15 }}>
      ...
      <div>
        ...
        <ul>
          <li data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
            <span style={{ fontSize: 15 }}>
              Use <span className="question">Sanchay's Blog</span>.{" "}
              <span className="question">
                Blog focused on special situations and event-driven investment
                ideas, focusing primarily on smaller companies
                (micro/nano-caps).
              </span>
            </span>
            <span className="statement-end-if-in-editor">
          ...
          <span style={{ fontSize: 15 }}>
            <span style={{ color: "rgb(127, 127, 127)" }}>
              <span data-custom-class="body_text">
                ...
                <span className="question">hello@sanchayjaveria.com</span>.
              </span>
            </span>
          </span>
        </div>
        ...
        <div style={{ lineHeight: "1.5" }}>
          <span style={{ fontSize: 15 }}>
            <span data-custom-class="body_text">
              ...
              <span className="statement-end-if-in-editor" /> in certain
        ...
        <div style={{ lineHeight: "1.5" }}>
          <span style={{ fontSize: 15 }}>
            <span data-custom-class="body_text">
              ...
              adequate <span className="block-component" />
              organizational
        ...
        <div style={{ lineHeight: "1.5" }}>
          ...
          <a
            ...
            href="https://app.termly.io/notify/6a8cbc0d-915c-4dea-a50b-1296ef8df35e"
