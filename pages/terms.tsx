  ...
  return (
    <div className="mt-10">
      ...
      <div className="mt-2">
        ...
        leave the website accordingly. Sanchay Javeria only grants use and
        access of this website, its products, and its services to those who have
        accepted its terms.
      </div>
      ...
      <div className="mt-2">
        ...
        years of age and you may legally adhere to this Agreement. Sanchay
        Javeria assumes no responsibility for liabilities related to age
        misrepresentation.
      </div>
      ...
      <div className="mt-2">
        ...
        website are the property of Sanchay Javeria, its affiliates, directors,
        ...
        Sanchay Javeria&apos;s intellectual property in any way, including
        electronic, digital, or new trademark registrations. You grant Sanchay
        Javeria a royalty-free and non-exclusive license to display, use, copy,
      ...
      <div className="mt-2">
        ...
        address it accordingly. We reserve all rights to terminate accounts,
        edit or remove content and cancel orders in their sole discretion.
      </div>
      ...
      <div className="mt-2">
        ...
        Sanchay Javeria and you, or its business partners and associates.
      </div>
      ...
      <div className="mt-2">
        You agree to indemnify Sanchay Javeria and its affiliates and hold
        Sanchay Javeria harmless against legal claims and demands that may arise
      ...
      <div className="mt-2">
        Sanchay Javeria is not liable for any damages that may occur to you as a
        result of your misuse of our website.
      </div>
      Sanchay Javeria reserves the right to edit, modify, and change this
      Agreement any time. We shall let our users know of these changes through
      electronic mail. This Agreement is an understanding between Sanchay
      Javeria and the user, and this supersedes and replaces all prior
